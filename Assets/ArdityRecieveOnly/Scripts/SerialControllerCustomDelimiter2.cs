 ...
 * a 1-char delimiter.
 */
public class SerialControllerCustomDelimiter2 : MonoBehaviour
{
    ...
    protected SerialThreadBinaryDelimited2 serialThread;
    ...
    void OnEnable()
    {
        serialThread = new SerialThreadBinaryDelimited2(portName,
                                                       baudRate,
                                                       reconnectionDelay,
                                                       maxUnreadMessages,
                                                       separator);
